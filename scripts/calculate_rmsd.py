...
"""
    ...
    #print(args.structure_a,args.structure_b)
    m1 = ptrn.search(args.structure_a)
    m2 = ptrn.search(args.structure_b)

    if m1 is None:
        print("can't parse this ", args.structure_a)
    else:
